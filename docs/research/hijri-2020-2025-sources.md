...
| YALLOP-1998 | Yallop classifier | B. D. Yallop, “A Method for Predicting the First Sighting of the New Crescent Moon,” NAO Technical Note 69, updated April 1998 | Best-time method, q polynomial, and six original zones. A stable original-publisher copy was not available at retrieval time; the bibliographic source must be obtained before admitting real-map fixtures. |
...
| MABIMS 2021 | Local predicate using Moon-centre geometric altitude and geocentric elongation, both inclusive | Corrected: geocentric and topocentric elongations are separate explicit fields and the predicate consumes the geocentric field. | MUIS wording says “exceed”; obtain the primary technical standard for equality and rounding. |
